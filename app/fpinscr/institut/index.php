      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title mb-0"><h2 class="text-center" >Institut de Formation en Gestion  </h2 > <br> <h6 class="text-center" >– 17 rue Yahia el Mazouni Val d’Hydra – Alger</h6 ><br>
